...
def stealthy_adversarial_attack(data, model, epsilon=0.25, perturbation_ratio=0.5, task_type='node_classification'):
    ...
    perturbed_edge_index = add_enhanced_trigger_nodes(data, target_nodes, num_trigger_nodes=8 if task_type == 'node_classification' else 5)
